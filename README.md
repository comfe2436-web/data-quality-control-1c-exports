...
- Сводные таблицы, расчетные листы и итоговый дашборд.
...
Excel, расчетные листы, табличная модель, проверки качества данных, условное форматирование, диаграммы, управленческий dashboard.
...
- построение Excel-отчета с проверочными и сводными листами;
